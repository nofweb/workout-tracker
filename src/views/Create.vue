<template>
  <div class="max-w-screen-md mx-auto px-4 py-10">
    ...
    >
     ...
     <!-- create  -->
      <div class="p-8 flex items-start bg-light-grey rounded-mb shadow-lg">
        <form @submit.prevent="createWorkout" class="flex flex-col gap-y-5 w-full">
          ...
          <!-- Workout Name -->
           <div class="flex flex-col">
            <label class="text-sm text-at-light-green mb-1">Workout Name</label>
            <input
              type="text"
              requiredc
           ...
           <!-- Workout type  -->
           <div class="flex flex-col">
            <label class="text-sm text-at-light-green mb-1">Workout Type</label>
            <select
              type="text"
              requiredc
              class="py-2  text-gray-500 focus:outline-none"
           ...
           <!-- Strength Tracking Input -->
            <div v-if="workoutType === 'strength'" class="flex flex-col gap-y-4">
              <div
                class="flex flex-col md:flex-row gap-x-6 gap-y-2 relative"
...
export default {
  ...
  setup() {
    ...
    const deleteExercise = (id) => {
      console.log("delete exercise button was clicked")
